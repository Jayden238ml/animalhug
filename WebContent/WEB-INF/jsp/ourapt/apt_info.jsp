		...
		<ul id="content">
			<li id="right">
				...
				<div class="titleNaviNew">
					<h3 class="subTitle">단지 안내</h3>
				</div>
				<!-- 타이틀/네비 끝 -->
				<div id="cont">
					<section class="sect_area sect_first_area">
						<img src="/static_root/images/common/apt_img2.png" alt="아파트이미지1" title="아파트이미지1" />
						<img src="/static_root/images/common/apt_img1.png" alt="아파트이미지1" title="아파트이미지1" />
					</section>
				</div>
				<!-- 본문내용 끝 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
			</li>
