...
<div id="header">
	<dl>
		<dt><a href="/main.do"><img src="/static_root/images/common/logo2.png" alt="animalHug 로고" title="animalHug 로고" /></a></dt>
		<dd>
			<ul id="menuArea">
				<li><a href="/user/animal/findAnimal.do">유기동물</a></li>
				<li><a href="javascript:fn_moveMenu('/user/Board/freeNoteBoard.do');">커뮤니티</a></li>
			</ul>
		</dd>
	...
	<div id="subMenuArea">
		<ul>
			...
			<li>
				<h1><a href="javascript:fn_moveMenu('/user/Board/findBoard.do');">커뮤니티</a></h1>
				<ul>
					<li><a href="javascript:fn_moveMenu('/user/Board/findBoard.do');">찾아주세요</a></li>
...
<div id="header-mobile">
	<dl class="hm-menu">
		...
		<dd><a href="/main.do"><img src="/static_root/images/common/logo2.png" height="30" alt="animalHug 로고" title="animalHug 로고" /></a></dd>
		<c:if test="${not empty INIT_DATA.SESSION_USR_ID}">
	...
	<div class="hm-total">
		...
		<div id="cssmenu">
			<ul>
				...
				<li class='has-sub'><a href='/user/Board/findBoard.do'><i class="fa fa-book" aria-hidden="true"></i><span>커뮤니티</span></a>
					<ul>
						<li><a href="javascript:fn_moveMenu('/user/Board/findBoard.do');"><i></i> <span>찾아주세요</span></a></li>
