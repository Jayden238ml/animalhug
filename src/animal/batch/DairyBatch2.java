...
public class DairyBatch2 extends QuartzJobBean
{
  ...
  public void runBatch()
  {
    boolean bol2 = false;
    boolean bol3 = false;
    boolean bol1 = InsertData("1", "417000");
    if (bol1) {
      bol2 = InsertData("1", "422400");
    }
    if (bol2)
      bol3 = InsertData("1", "429900");
  }
  ...
  public boolean InsertData(String type, String upkindcd)
  {
    ...
    try
    {
      ...
      String nm = "";
      if ("417000".equals(upkindcd)) nm = "개";
      if ("422400".equals(upkindcd)) nm = "고양이";
      if ("429900".equals(upkindcd)) nm = "기타";
      if ("1".equals(type))
        this.log.debug("######################## 공고중 " + nm + "( " + cnt + " )개 저장됨#########################");
      else {
        this.log.debug("######################## 보호중 " + nm + "( " + cnt + " )개 저장됨#########################");
      }
      rtn = true;
    }
    catch (Exception ex) {
